      ...
      systemd.services.media-bindfs = {
        ...
        serviceConfig = {
          ...
          ExecStart = [
            ...
            "${pkgs.bindfs}/bin/bindfs --force-user=aiden --force-group=media --create-for-user=aiden --create-for-group=media --perms=ug+rwX,o+rX --map=aiden/immich /media/t7 /srv/media"
          ];
